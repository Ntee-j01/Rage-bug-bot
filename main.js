   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +263714497545")))
            process.exit(0)
         }
      } else {
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFor example: +263714497545 : `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')
...
ppuser = 'https://i.postimg.cc/FssKzLK7/20240622-140407.jpg?q=60'
}
try {
ppgroup = await XeonBotInc.profilePictureUrl(anu.id, 'image')
} catch (err) {
...
ppgroup = 'https://i.postimg.cc/FssKzLK7/20240622-140407.jpg?q=60'
}
			console.log(json)
			const res = json[0]
